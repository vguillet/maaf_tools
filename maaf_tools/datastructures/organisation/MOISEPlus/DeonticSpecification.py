...
if __name__ == "__main__":
    ...
    deontic_spec.add_permission(role="Patroller", mission="m_patrolling")
    deontic_spec.add_permission(role="Obstructor", mission="m_interdiction")
    deontic_spec.add_permission(role="Obstructor", mission="m_obstructing")
    deontic_spec.add_permission(role="Trapper", mission="m_interdiction")
    deontic_spec.add_permission(role="Trapper", mission="m_trapping")
    deontic_spec.add_permission(role="Tracker", mission="m_tracking")
    deontic_spec.add_permission(role="Neutraliser", mission="m_neutralising")
